...
const tracks: Track[] = [
  ...
  },
  {
    ...
    audioSrc: import.meta.env.BASE_URL +"/audio/arctic.mp3",
    waveformSrc: import.meta.env.BASE_URL +"/images/arctic.jpeg",
    lyrics: [
      "",
  ...
  },
  {
    ...
    title: "Amazing Day",
    artist: "Coldplay",
    audioSrc: import.meta.env.BASE_URL +"/audio/coldplay1.mp3",
  ...
  },
  {
    ...
    artist: "Lady Gaga",
    audioSrc: import.meta.env.BASE_URL +"/audio/bruno.mp3",
    waveformSrc: import.meta.env.BASE_URL +"/images/bruno.jpeg",
    lyrics: [
  ...
  },
  {
    ...
    title: "Lo que siento",
    artist: "Cuco",
    audioSrc: import.meta.env.BASE_URL +"/audio/cuco.mp3",
    waveformSrc: import.meta.env.BASE_URL +"/images/cuco.jpg",
    lyrics: [
...

  {
    ...
    title: "Here With Me",
    artist: "d4vd",
    audioSrc: import.meta.env.BASE_URL +"/audio/d4vd.mp3",
    waveformSrc: import.meta.env.BASE_URL +"/images/d4vd.jpg",
    lyrics: [
      "And if it's right",
  ...
  },
  {
    ...
    title: "Golden Hour",
    artist: "JVKE",
    audioSrc: import.meta.env.BASE_URL +"/audio/jvke.mp3",
    waveformSrc: import.meta.env.BASE_URL +"/images/jvke.png",
    lyrics: [
